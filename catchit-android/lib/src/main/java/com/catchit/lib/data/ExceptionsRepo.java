...
public class ExceptionsRepo {
    ...
    private ExceptionsRepo(Context applicationContext, AppExecutors appExecutors)
    {
        ...
        NetworkProvider networkProvider = new NetworkProvider.Builder().build();
    ...
    public static class Builder {
        ...
        public ExceptionsRepo build() {
            ...
            return new ExceptionsRepo(mApplicationContext, mExecutors);
        }
    }
}