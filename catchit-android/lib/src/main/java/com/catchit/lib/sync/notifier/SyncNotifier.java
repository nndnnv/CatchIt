...
public class SyncNotifier {
    ...
    private final static List<TimeUnit> SUPPORTED_TIME_UNITS = Arrays.asList(TimeUnit.SECONDS, TimeUnit.MINUTES);
    ...
    public static class Builder {
        ...
        public SyncNotifier.Builder setIntervalTimeUnit(TimeUnit syncIntervalTimeUnit) {
            ...
            if(!SUPPORTED_TIME_UNITS.contains(syncIntervalTimeUnit)) {
                throw new IllegalArgumentException("SyncNotifier supports only TimeUnit.MINUTES and TimeUnit.SECONDS as for now");
            }
